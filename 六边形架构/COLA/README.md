...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230426174545.png)

换一个视角，从 COLA 应用处理响应一个请求的过程来看。COLA 使用了 CQRS 来分离命令和查询的职责，使用扩展点和元数据来提升应用的扩展性。

![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230426174602.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230426174620.png)
